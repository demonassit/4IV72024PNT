...
function validar(formulario){
    ...
    var abcOK = "qwertyuiopasdfghjklñzxcvbnm"+"QWERTYUIOASDFGHJKLÑZXCVBNM";
    ...
    //vamos hacer un bucle mediante el cual primero obtenga la cadena del nombre y la separa en caracteres, una vez que tenga cada caracter debo de comparlo con la cadena que en este momento estoy considerando como la verdad absoluta y si despues de recorrer toda la cadena encuentro que el caracter no se encuentra envie un error
